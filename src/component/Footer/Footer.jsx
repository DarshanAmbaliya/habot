  ...
  const socialItem = [
    {
      ...
      ,
      link: 'https://www.linkedin.com/company/habot-connect/?trk=public_profile_experience-item_profile-section-card_subtitle-click&originalSubdomain=in',
    },
    {
      id: Math.floor(Math.random() * 1000),
      icon:
        <div style={{ display:"flex",justifyContent: "center", alignItems:"center", height:"40px", width: "40px", border:"1px solid #3d5975", borderRadius: "50%" }}>
          <i class="bi bi-twitter-x" style={{ "color": "white" }}></i>
        </div>
      ,
      link: 'https://x.com/HabotConnect/status/1458667701639909376',
    },
    {
      id: Math.floor(Math.random() * 1000),
      icon: <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      ,
      link: 'https://www.facebook.com/habotconnect/',
    },
    {
      id: Math.floor(Math.random() * 1000),
      icon: <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      ,
      link: 'https://www.instagram.com/habotconnect/',
    },
  ]
  return (
    <>
