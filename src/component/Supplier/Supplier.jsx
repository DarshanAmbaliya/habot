                      ...
                      (selectedTab === "buyer") && (
                        <div className="buyer">
                          <ul className="text-white text-[18.75px]">
                            <li className="flex gap-[9px] py-[4px]">
                            ...
                            <li className="flex gap-[9px] py-[4px]">
                              ...
                              <p>Choose among the suppliers based on the rating and reviews.</p>
                            </li>
                          </ul>
                        </div>
                      )
                        ...
                        <div className="seller">
                          <ul className="text-white text-[18.75px]">
                            ...
                            <li className="flex gap-[9px] py-[4px]">
                              ...
                              <p>Select service tags for relevant opportunities</p>
                            </li>
                            <li className="flex gap-[9px] py-[4px]">
                              <span className="mt-[8px]">
                                <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                              ...
                              <p>Reach out to buyers and expand your business</p>
                            </li>
                          </ul>
                        </div>
                      )
